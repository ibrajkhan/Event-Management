...
export async function buildAttendeeExport(attendees) {
  ...
  sheet.columns = [
    ...
    { header: "Kit Distribution Status", key: "kitDistributionStatus", width: 20 },
  ...
  attendees.forEach((attendee) => {
    sheet.addRow({
      ...
      kitDistributionStatus: attendee.attendance?.kitDistribution?.scannedAt ? "Distributed" : "Pending",
